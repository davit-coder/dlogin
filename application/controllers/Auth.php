...
class Auth extends CI_Controller {
	...
	private function _sendEmail($token, $type)
	{
		$config = [
			...
			'smtp_user' => 'webcsnotreplay@gmail.com',
			'smtp_pass' => '02feb1990',
			'smtp_port' => 465,
			'mailtype' => 'html',
			'charset' => 'utf-8',
		...
		$this->email->from('webcsnotreplay@gmail.com', 'dLogin Programming');
		...
		if ($user) {
			...
			if ($user_token) {
				if (time() - $user_token['date_created'] < (60*60*24)) {
					// seteleh verifikasi benar semua
